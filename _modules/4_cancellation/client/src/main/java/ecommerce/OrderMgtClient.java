...
//        logger.info("GetOrder Response -> : " + orderResponse.toString());
        ...
        // Search Orders
        StringValue searchStr = StringValue.newBuilder().setValue("Google Nest Hub").build();
        ...
        while (matchingOrdersItr.hasNext()) {
            ...
            if(Integer.parseInt(order.getId()) == 104) {
                boolean result = withCancellation.cancel(null);
                logger.info("Cancelled ---> " + result);
            }
        }
